...
<form action="edit_users.php?id=<?php echo $id?>" method="post">
	...
	<span  class="form-control mt-2"><?php echo $password?></span>
	<span  class="form-control mt-2"><?php echo $name?></span>
	<a class="btn btn-outline-danger mt-2" href="del_user.php?id=<?php echo $id ?>"> DELETE <b>ID:</b> <?php echo $id ?></a>
	<button class="btn btn-outline-dark mt-2" type="submit" name="post" value="update" class="btn btn-outline-info"><?php echo $badge?></button>
	</div>

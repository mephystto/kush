...
<?php
	...
	$sql = "SELECT * FROM videos WHERE title LIKE '%$searchq%' OR tag LIKE '%$searchq%'";
	$result = $conn->query($sql);
	echo "<h3 class='lead ml-1'><span class='badge badge-warning'>$result->num_rows</span> Results</h3>";	
	if(isset($result->num_rows)){
		...
		$out = strlen($content) > 50 ? substr($content,0,125)."<a style='color:#fe9090;' href='display.php?v=$out_title'>...</a>" : $content;
...
<div>
<img class="p-1" width='100' height='80' src='<?php if ($extensionimage != "jpg" && $extensionimage != "png" && $extensionimage != "gif"){echo "pod.jpg";}else{echo $image;}?>'></img>	
</div>
<div class="p-1">
</a>
<!--THUMBNAIL-->
